        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 xl:gap-10">
          {testimonials.map((testimonial) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm lg:text-base truncate">{testimonial.location}</p>
                </div>
              </div>
              <p className="text-gray-700 mb-4 sm:mb-6 text-sm sm:text-base lg:text-lg leading-relaxed">{testimonial.comment}</p>
